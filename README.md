...
- Path to the Mbed program (e.g., the current working directory).
...
properties file. `--vscode-config-path` can also be used to specify the
...
$ mbed-config-gen -t GCC_ARM -m DISCO_L072CZ_LRWAN1 -p . --output Header
...
$ mbed-config-gen -t GCC_ARM -m DISCO_L072CZ_LRWAN1 -p . --output VSCode --vscode-config-name Linux
Compile-time definitions /home/lab/mbed-projects/test/cmake_build/DISCO_L072CZ_LRWAN1/develop/GCC_ARM/mbed-os/compile_time_defs.txt generated by Mbed CMake toolchain is being used. Make sure that `mbed-tools configure` is run before using this tool.
...
$ mbed-config-gen -t GCC_ARM -m DISCO_L072CZ_LRWAN1 -p . --output Header --additional-macros-path macros.txt 
Compile-time definitions /home/lab/mbed-projects/test/cmake_build/DISCO_L072CZ_LRWAN1/develop/GCC_ARM/mbed-os/compile_time_defs.txt generated by Mbed CMake toolchain is being used. Make sure that `mbed-tools configure` is run before using this tool.
/home/lab/mbed-projects/test/mbed_config.h has been successfully created.
